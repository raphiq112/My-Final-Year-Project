...
def _compute_sentiment(comments, analyzer):
    ...
    scored_texts = []  # (text, compound) — used for sample comments + word cloud
    ...
    for c in comments:
        ...
        weight_total += w
        scored_texts.append((text, s["compound"]))
    ...
    # Surface the 3 most sentiment-extreme comments (by |compound|) as a
    # quick preview — shown in the "Sample sentiment fetched" expander on
